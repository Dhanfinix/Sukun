...
1. **`main`** 
   ...
   - Merging to `main` automatically triggers the GitHub Action (`release-github.yml`) to build the APK and create a **GitHub Release** with version tags.
