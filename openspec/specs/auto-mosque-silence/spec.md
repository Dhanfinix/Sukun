# Capability: Auto-Mosque Silence

## Overview
Automates the process of silencing the device based on proximity to mosques, with granular user control over global and individual mosque triggers.
